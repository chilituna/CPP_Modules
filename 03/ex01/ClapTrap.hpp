...
/*   Updated: 2024/08/31 21:28:32 by aarponen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	public:
		...
		virtual ~ClapTrap(void); // Ensures proper cleanup in derived classes when an object is deleted through a base class pointer.
